# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-04-01 21:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('suggestion', models.CharField(choices=[('D', 'Disbursement'), ('L', 'Loan')], default='D', max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('O', 'Outstanding'), ('A', 'Approved'), ('D', 'Denied'), ('P', 'In Progress'), ('L', 'Loaned'), ('R', 'Returned'), ('Z', 'Hacky Log Status')], default='O', max_length=1)),
            ],
        ),
        migrations.CreateModel(
